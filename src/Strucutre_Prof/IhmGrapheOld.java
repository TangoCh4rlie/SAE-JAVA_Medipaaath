...
public class IhmGrapheOld extends JFrame {
    ...
    public IhmGrapheOld(LCGraphe graphe) {
        this.graphe = graphe;
...
//        content.setLayout(new BorderLayout());
        for (LCGraphe.MaillonGraphe m : this.listSommet) {
            ...
            sommet.setBounds((int) m.getCoordonnees().getX(), (int) m.getCoordonnees().getY(), 40, 40);
...
//        content.setLayout(new BorderLayout());
        for (LCGraphe.MaillonGraphe m : this.listSommet) {
            ...
            for (LCGraphe.MaillonGraphe m2 : listSuccesseur) {
                g.drawLine((int) (m.getCoordonnees().getX() + 25), (int) (m.getCoordonnees().getY() + 25), (int) (m2.getCoordonnees().getX() + 25), (int) (m2.getCoordonnees().getY() + 25));
